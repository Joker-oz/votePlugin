...
<div class="middle">
	<div class="choose">
	<a href=""><button class="choose" id="choose1"><span class="choose" id="choose1">人物投票</span></button></a>
	<button class="choose" id="choose2"><span class="choose" id="choose2">作品投票</span></button>
	</div>
    <form method="post" enctype="multipart/form-data" action="{{url('')}}/vote/store" class="mod-pic">
      <div class="title">
